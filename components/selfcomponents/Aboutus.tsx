  ...
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 ref={headingRef} className="font-mono text-4xl font-extrabold text-white sm:text-5xl">
           <HyperText >About us </HyperText>
          </h2>
          <p ref={textRef1} className="mt-4 max-w-4xl mx-auto text-xl text-white/80 font-sans text-justify">
